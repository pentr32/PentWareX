...
namespace PentWareX.SDK
{
    ...
    {
        public static bool IsIngame => Structs.ClientState.GameState == (int)Enums.GameState.GAME
           && Extensions.Proc.IsWindowFocues(Globals.Proc.Process);
        ...
        public static bool IsMachineGun(int id) => id == (int)Enums.ClassIDs.CWeaponNegev
        ...
        public static bool IsShotgun(int id) => id == (int)Enums.ClassIDs.CWeaponXM1014
